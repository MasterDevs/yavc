...
namespace yavc.Base.Commands {
	...
	public class SelectCurrentListItem : ACommand {

		public string InputName { get; set; }
		
		public SelectCurrentListItem(Input i) {
		...
		protected override RequestInfo[] GetRequestInfo() {
			return new RequestInfo[] {
				RequestInfo.GenRequest(yavcMethod.Post, ListRequests.GetSelectRequest(InputName))
			};
		}
	}
